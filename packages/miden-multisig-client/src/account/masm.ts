...
export const MULTISIG_ECDSA_MASM = `# Multi-Signature ECDSA secp256k1 Authentication Component
#
# This component provides multi-signature authentication for accounts using
...
pub proc auth_tx_ecdsa_multisig(salt: BeWord)
    ...
    # ------ Verifying PSM Signature ------
    # => [TX_SUMMARY_COMMITMENT]
    call.psm_ecdsa::verify_psm_signature
